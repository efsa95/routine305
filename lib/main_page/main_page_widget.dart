...
class _MainPageWidgetState extends State<MainPageWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      FFAppState().currentMonth = functions.getCurrentMonth()!;
      FFAppState().currentDay = functions.getCurrentDay()!;
      FFAppState().currentDayofMonth = functions.getCurrentDayofMonth()!;
      safeSetState(() {});
    });
