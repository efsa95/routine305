                    ...
                    children: [
                                                                ...
                                                                queryBuilder:
                                                                    (exercisesRecord) =>
                                                                        exercisesRecord
                                                                            .where(
                                                                              'user',
                                                                              isEqualTo: personalUserWorkoutsItem.user,
                                                                            )
                                                                            .where(
                                                                              'getWorkoutName',
                                                                              isEqualTo: personalUserWorkoutsItem.workoutName,
                                                                            ),
                                                              ),
                                                              builder: (context,
                                                                  snapshot) {
                                                                    ...
                                                                    return InkWell(
                                                                      ...
                                                                      onTap:
                                                                        ...
                                                                        _model.selectedExerciseFromText =
                                                                            listViewExercisesRecord.exerciseName;
                                                                        _model.exerciseReps =
                                                                            listViewExercisesRecord.desiredReps;
                                                                        ...
                                                                        safeSetState(
                                                                          ...
                                                                          _model
                                                                              .textController1
                                                                              ?.text = listViewExercisesRecord.desiredReps.toString();
                                                                        });
                                                                        logFirebaseEvent(
                                                                            'Container_set_form_field');
                                                                        safeSetState(
                                                                          ...
                                                                          _model
                                                                              .textController2
                                                                              ?.text = _model.exerciseWeight.toString();
                                                                        });
                                                                      },
                                                                      child:
                                                                          Container(
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent(
                                'SUBMIT_WORKOUT_PAGE_BACK_BTN_ON_TAP');
                            logFirebaseEvent('Button_navigate_back');
                            context.safePop();
                          },
                          text: 'Back',
